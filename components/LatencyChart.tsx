  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-black/30 p-4">
      <div className="flex items-center justify-between">
        <div className="text-xs text-white/60">Latency comparison (sim)</div>
      ...
      <div className="mt-3 space-y-2">
        <div>
          <div className="mb-1 text-[11px] text-white/70">Edge (near user)</div>
          <div className="h-3 rounded-full bg-white/10">
            <div className="h-3 rounded-full bg-emerald-400/90" style={{ width: `${edgeW}%` }} />
          </div>
        </div>
        <div>
          <div className="mb-1 text-[11px] text-white/70">Central server (simulated)</div>
          <div className="h-3 rounded-full bg-white/10">
      ...
      <p className="mt-3 text-[11px] text-white/55">
        Origin latency is simulated to illustrate global acceleration benefits in demos.
      </p>
    </div>
  );
}
