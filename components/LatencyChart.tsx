  ...
  return (
    <div className="rounded-2xl border border-black/10 bg-white p-4 dark:border-white/10 dark:bg-black/30">
      <div className="flex items-center justify-between">
        <div className="text-xs text-black/60 dark:text-white/60">Latency comparison</div>
      ...
      <div className="mt-3 space-y-2">
        <div>
          <div className="mb-1 text-[11px] text-black/70 dark:text-white/70">Edge (end-to-end)</div>
        ...
        <div>
          <div className="mb-1 text-[11px] text-black/70 dark:text-white/70">Central server (simulated baseline)</div>
          <div className="h-3 rounded-full bg-black/10 dark:bg-white/10">
      ...
      <p className="mt-3 text-[11px] text-black/55 dark:text-white/55">
