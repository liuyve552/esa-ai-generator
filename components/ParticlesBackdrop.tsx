export default function ParticlesBackdrop() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_12%,rgb(var(--esa-accent-rgb)/0.22),transparent_60%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_18%,rgb(var(--esa-accent-rgb)/0.14),transparent_58%)]" />
